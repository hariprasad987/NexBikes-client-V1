    ...
    <Card aria-label="Bike part help" className={styles.section}>
      <article className={styles.supportCard}>
        <div className={styles.heading}>
          <Icon aria-hidden="true" name="help-question" size={24} />
          <h2>Need a specific part?</h2>
        </div>
        <p>We&apos;ll help you find the right part from trusted sellers.</p>
        <Button className={styles.action} leadingIcon={<Icon name="input-search" size={18} />}>
          Find This Part
        </Button>
      </article>
      ...
      <article className={styles.supportCard}>
        ...
        <ButtonLink href="#tools-resources" className={styles.guideAction} leadingIcon={<Icon name="guide" size={18} />} variant="secondary">
